    ...
    <div class="admin-view-wrapper">
        ...
        <v-window v-model="tab" id="window">
            <v-window-item value="Indicadores" class="window-item" >
                ...
                <AlertaInfo v-if="alertaUploadIndicadores" idAlerta="alertaUploadIndicadores" mensagem="Insira um arquivo para fazer Upload!"></AlertaInfo>
                ...
                <AlertaInfo v-if="alertaRequisicaoIndicadores" idAlerta="alertaRequisicaoIndicadores" :mensagem="mensagemRequisicaoIndicadores" :bgColor="bgAlertaReqIndi" :textColor="colorReqIndi"></AlertaInfo>
            ...
            <v-window-item value="Metas" class="window-item" >
                ...
                <AlertaInfo v-if="alertaUploadMetas" idAlerta="alertaUploadMetas" mensagem="Insira um arquivo para fazer Upload!"></AlertaInfo>
                ...
                <AlertaInfo v-if="alertaRequisicaoMetas" idAlerta="alertaRequisicaoMetas" :mensagem="mensagemRequisicaoMetas" :bgColor="bgAlertaReqMetas" :textColor="colorReqMetas"></AlertaInfo>
